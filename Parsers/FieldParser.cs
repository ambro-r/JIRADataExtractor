...
namespace JIRADataExtractor
{
    ...
    {
        public FieldParser(ConnectionHandler connectionHandler) : base(connectionHandler)
        {
        }
        ...
        public List<Field> GetFields() {
            ...
            string jSONResponse = ConnectionHandler.BasicAuthentication("/rest/api/3/field");
